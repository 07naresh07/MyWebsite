    ...
    <div className="relative inline-flex items-center select-none group">
      ...
      <div
        className="
          ...
          transform -rotate-[30deg] transition-all duration-500 ease-out
          ...
          {!prefersReduced && (
            <div
              className="
                ...
                bg-gradient-to-r from-yellow-300 to-pink-300 transform -translate-x-full
              "
              style={{
            ...
            <div className="pt-4 space-y-1 border-t border-slate-200/50 dark:border-slate-700/50">
              {navigationItems.map(({ to, icon: Icon, label }) => (
                <NavLink
                  ...
                  className={({ isActive }) => `
                    ${getNavLinkClass({ isActive })} w-full justify-start text-lg
                  `}
                >
                  <Icon size={18} />
                  <span>{label}</span>
