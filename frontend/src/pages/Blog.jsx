...
export default function Blog() {
  ...
  useEffect(() => {
    localStorage.setItem("blogDarkMode", String(darkMode));
  }, [darkMode]);
  ...
  // Refresh when localStorage changes (other tabs) or when you come back to the tab
  useEffect(() => {
            ...
            <div className="max-w-md mx-auto">
              ...
              <p className={`${darkMode ? "text-gray-300" : "text-gray-600"} mb-6`}>
                {q || selectedTag
                  ...
                  : "This is where amazing stories will live. Start creating your first post!"}
              </p>
              {q || selectedTag ? (
                <button
                ...
                <button
                  onClick={() => nav("/blog/edit/new")}
                  className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                >
                  <Icons.Plus />
